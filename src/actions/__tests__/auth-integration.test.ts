...
describe('Authentication Integration Tests', () => {
  ...
  describe('User Profile Integration', () => {
    it('should create user profile after signup', async () => {
      ...
      expect((result.data as any)?.current_tier).toBe('bronze')
    })
    ...
    it('should fetch user profile with XP and tier', async () => {
      ...
      expect((result.data as any)?.current_tier).toBe('silver')
      expect((result.data as any)?.badges).toContain('first_purchase')
    })
  })
