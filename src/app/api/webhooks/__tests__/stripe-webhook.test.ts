...
describe('Webhook Integration Tests', () => {
  ...
  describe('Stripe Webhook - checkout.session.completed', () => {
    ...
    it('should award XP for purchase', async () => {
      ...
      await awardXpForPurchase(userId, orderId, totalCents)

      expect(awardXpForPurchase).toHaveBeenCalledWith(userId, orderId, totalCents)
    })
  ...
  describe('Order Creation Flow', () => {
    ...
    it('should handle Printful order creation', async () => {
      ...
      expect(result.printfulOrderId).toBe(123)
    })
  })
  ...
  describe('Error Handling', () => {
    ...
    it('should handle email sending failure', async () => {
      ...
      vi.mocked(sendOrderConfirmation).mockRejectedValue(new Error('Email service unavailable'))
    ...
    it('should handle Printful API failure', async () => {
      ...
      vi.mocked(createOrder).mockRejectedValue(new Error('Printful API error: Invalid variant'))
  ...
  describe('Referral System Integration', () => {
    it('should award XP to referrer on first purchase', async () => {
      ...
      await awardXpForReferral(referrerId)

      expect(awardXpForReferral).toHaveBeenCalledWith(referrerId)
    })
