  ...
  return (
    <div className="min-h-screen px-4 py-12">
      <div className="mx-auto max-w-2xl space-y-12">
        <h1 className="text-2xl font-bold text-zinc-50">Account</h1>
        ...
        <section>
          <h2 className="mb-4 text-lg font-semibold text-zinc-50">Profile</h2>
          <div className="rounded-lg border border-zinc-800 bg-zinc-900/80 p-6">
            <p className="text-zinc-400">
              <span className="font-medium text-zinc-300">Email:</span> {user.email}
            </p>
        ...
        <section>
          <h2 className="mb-4 text-lg font-semibold text-zinc-50">Addresses</h2>
          <AddressList addresses={addresses ?? []} />
        </section>

        <section>
          <h2 className="mb-4 text-lg font-semibold text-zinc-50">Wishlist</h2>
          <Link
        ...
        <section>
          <h2 className="mb-4 text-lg font-semibold text-zinc-50">Orders</h2>
          <Link
            href="/account/orders"
            className="inline-flex items-center rounded-lg border border-zinc-700 bg-zinc-800 px-4 py-2 text-sm text-zinc-100 transition hover:bg-zinc-700"
          >
        ...
        <section>
          <h2 className="mb-4 text-lg font-semibold text-zinc-50">Security</h2>
          <Link
