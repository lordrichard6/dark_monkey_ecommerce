                            ...
                            <div className="grid grid-cols-2 gap-8">
                                ...
                                >
                                    <div className="relative z-10">
                                        <span className="text-xs font-bold uppercase tracking-widest text-amber-500">{t('featured')}</span>
                                ...
                                >
                                    <div className="relative z-10">
                                        <span className="text-xs font-bold uppercase tracking-widest text-purple-500">{t('creative')}</span>
