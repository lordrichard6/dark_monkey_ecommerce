...
export function ShareButton({ productName, productUrl, productImage, iconOnly }: ShareButtonProps) {
  ...
  return (
    <div className="relative">
      <button
        ...
        className={
          iconOnly
            ? 'flex h-13 w-13 items-center justify-center rounded-full border border-white/10 bg-white/[0.03] text-zinc-400 transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] hover:border-white/20 hover:text-zinc-200 active:scale-95'
            : 'flex items-center gap-2 rounded-lg border border-zinc-700 bg-zinc-800 px-4 py-2.5 text-sm font-medium text-zinc-300 transition hover:bg-zinc-700'
        }
      >
