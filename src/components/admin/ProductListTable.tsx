                    ...
                    <tbody>
                        {safeProducts.map((p) => {
                            ...
                            return (
                                <tr
                                    key={p.id}
                                    className={`border-b border-zinc-800/50 transition-colors ${isSelected ? 'bg-amber-500/5' : ''
                                        }`}
                                >
                                    ...
                                    <td className="px-4 py-3">
                                        <span
                                            className={`rounded px-2 py-0.5 text-xs ${p.is_active
            ...
            <div className="grid grid-cols-1 gap-4 md:hidden">
                {safeProducts.map((p) => {
                    ...
                    return (
                        <div
                            key={p.id}
                            className={`relative flex flex-col gap-3 rounded-lg border border-zinc-800 bg-zinc-900/50 p-4 transition-colors ${isSelected ? 'border-amber-500/50 bg-amber-500/5' : ''
                                }`}
                        >
