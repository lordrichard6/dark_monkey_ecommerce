...
import { HelpCircle, X, FileText, Mail, Clock, LifeBuoy } from 'lucide-react'
          ...
          <div className="p-2">
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="font-medium">{t('visitFaq')}</span>
                <span className="text-[10px] text-zinc-500">{t('faqDescription')}</span>
              </div>
            </Link>
            ...
            {isLoggedIn && (
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="font-medium">{t('openTicket')}</span>
                  <span className="text-[10px] text-zinc-500">{t('ticketDesc')}</span>
                </div>
              </Link>
            )}
