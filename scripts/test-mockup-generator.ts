...
async function run() {
  ...
  const frontPrintUrl =
    'https://files.cdn.printful.com/files/33f/33fd2f09b543d4d07e3c0e1ac5143f61_preview.png'
  const backPrintUrl =
    'https://files.cdn.printful.com/files/cf5/cf5e6b3780cb0bfa1102bba22dc7bb9d_preview.png'
